...
function eventClick() {
    ...
    document.getElementById("eventStateBtn").style.background = "#004e6d";
    document.getElementById("stateOptions").innerHTML = '';
    document.getElementById("dataDiv").innerHTML = '<input type="hidden" id="type" name="type" value="event"><label for="event" id="eventLabel">Select an event</label><select name="event" id="event" class = "formInput"><option value="Butterfly">Butterfly</option><option value="Backstroke">Backstroke</option><option value="Breaststroke">Breaststroke</option><option value="Freestyle">Freestyle</option></select><br><label for="site" id="siteLabel">Site ID</label><input type="text" placeholder="Enter Site ID" name="site" id="site" class="formInput" required><br><label for="attendance" id="attendanceLabel">Number of Attendees</label><input type="text" placeholder="Attendance Number" name="attendance" id="attendance" class="formInput" required><br><label for="series" id="seriesLabel">Series Index</label><input type="text" placeholder="Enter Series Index" name="series" id="series" class="formInput" required><br>';
}
...
function eventStateClick() {
    ...
    document.getElementById("tournamentBtn").style.background = "#004e6d";
    document.getElementById("eventBtn").style.background = "#004e6d";
    document.getElementById("dataDiv").innerHTML = '<div class="insertDiv"><br><input type="hidden" id="type" name="type" value="eventState"><label for="event" id="eventLabel">Event ID</label><input type="text" placeholder="Enter Event ID" name="event" id="event" class="formInput"><br><label for="sequence" id="sequenceLabel">Sequence Number</label><input type="text" placeholder="Enter Sequence Number" name="sequence" id="sequence" class="formInput" ><br><label for="time" id="timeLabel">Time Elapsed</label><div><input type="text" placeholder="Min" name="timeMin" id="timeMin" class="formInputTime" >:<input type="text" placeholder="Sec" name="timeSec" id="timeSec" class="formInputTime" ></div><br><label for="raceState" id="raceStateLabel">Current Race State</label><select name="raceState" id="raceState" class = "formInput"><option value="before">before</option><option value="during">during</option><option value="after">after</option></select></div><br><div class="insertDiv" id = "stateDiv"></div><br>';
